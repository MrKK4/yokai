        ...
        YokaiScaffold(
            ...
            LazyColumn(
                ...
                items(
                    ...
                    // ⚡ Bolt: Using items() instead of forEach { item { ... } } allows Compose to properly
                    // recycle components, avoid unnecessary nested layouts, and optimize performance for lists.
                    ExtensionRepoItem(
                        extensionRepo = repo,
